...
> ⚠️ **Canonical copy now lives at [`docs/API_CONTRACT.md`](docs/API_CONTRACT.md)**, alongside the machine-readable [`docs/openapi.json`](docs/openapi.json). Use those as the source of truth; this file is kept as a mirror.

For the **frontend developer**. This is the full request/response contract for
every endpoint. Live interactive docs are always available at
`http://localhost:8000/docs` (Swagger) — this file is the human-readable version.
